...
func main() {
	...
	prov, err := provider.NewAwsProvider(ctx, executionEnv.ProviderConfigFile, executionEnv.ControllerID, executionEnv.InterfaceVersion, executionEnv.PoolID, executionEnv.ExtraSpecs)
	if err != nil {
